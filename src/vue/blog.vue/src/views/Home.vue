    ...
    <div class="l_body">
      <div class='container clearfix'>
        <div class='l_main'>
          ...
          <nav id="page-nav">
            <router-link :to="'GetBlogs/?page=' + (page>1?page-1:1)" class="prev" rel="prev">
              {{(page>1? "pre": "")}}

            </router-link>
            <router-link :to="'GetBlogs/?page=' + (page>=TotalCount? TotalCount: page+1)" class="next" rel="next">
...
export default {
  ...
  methods: {
    getData() {
      ...
      this.$api.get("Blog/GetBlogs/?page=" + that.page, null, r => {
